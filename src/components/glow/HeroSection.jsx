  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <img
          src="https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=1400&q=85&auto=format&fit=crop&crop=top"
          alt="Warm editorial portrait of a woman with glowing skin in soft afternoon light"
          className="w-full h-full object-cover object-top"
        />
        {/* Strong gradient for mobile text legibility */}
        <div
          className="absolute inset-0"
          style={{
            background:
              "linear-gradient(to bottom, rgba(30,27,24,0.3) 0%, rgba(30,27,24,0.55) 50%, rgba(30,27,24,0.85) 100%)",
          }}
        />
      </div>

      {/* Content — centred on all devices */}
